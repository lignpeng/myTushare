...
# '''3、第三行的控件，空白，刷新：update_stocklist_btn
        ...
        self.update_stocklist_btn = QtWidgets.QPushButton(self.centralwidget)
        self.update_stocklist_btn.setMinimumSize(QtCore.QSize(marginWidth, 0))
        self.update_stocklist_btn.setMaximumSize(QtCore.QSize(marginWidth, 16777215))
        self.update_stocklist_btn.setObjectName("update_stocklist_btn")
        self.horizontalLayout_5.addWidget(self.update_stocklist_btn)
...
# '''8、执行，commandLinkButton:开始绘图'''
        ...
        self.horizontalLayout_action.addItem(spacerItem3)
...
# '''---------------'''
        ...
        MainWindow.setWindowTitle("myTushare")
        # self.init_category_btn.setText("分类")
        self.update_stocklist_btn.setText("更新列表")
